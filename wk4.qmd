...
Central regions of Denver experience a heat island effect relative to its surroundings that ranges anywhere from 3.5 to 4.2C depending on the time of day and current season [@thunenUrbanHeatIsland2013]. Cooling the city is a critical goal, and the UN Environment Programme identifies heat mitigation in urban areas as a goal of immense importance in its 'Beating the Heat' handbook for cities. [@environmentBeatingHeatSustainable2021]. Denver itself indicates in its climate action plan, the city is likely to experience increasingly intense heat events in coming decades and that improving resilience along this dimension is critical [@cityofdenverDenver80502018].
